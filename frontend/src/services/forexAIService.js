...
class ForexAIService {
  ...
  async generateDailyRecap() {
    ...
    try {
      ...
      // Build enhanced prompt with economic data
      let prompt = `Analyse le marché forex d'aujourd'hui (${new Date().toLocaleDateString('fr-FR')}). `;
      ...
      if (Object.keys(economicData).length > 0) {
        ...
        prompt += `\n\nUtilise ces données officielles dans ton analyse.`;
      }
      ...
      try {
        ...
        return {
          ...
          aiInsights: {
            ...
            confidence: 90,
            mainTrend: "Basé sur analyse Perplexity AI + données FRED",
